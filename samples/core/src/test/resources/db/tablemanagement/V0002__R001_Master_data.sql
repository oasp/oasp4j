...
INSERT INTO ORDERPOSITION (id, modificationCounter, offer_id, offername, comment, state, mealState, sidedishState, drinkState, order_id, price) VALUES (1, 1, 1, 'Schnitzel-Menü', 'mit Ketschup', 2, 2, 2, 2, 1, 6.99);
INSERT INTO ORDERPOSITION (id, modificationCounter, offer_id, offername, comment, state, mealState, sidedishState, drinkState, order_id, price) VALUES (2, 1, 2, 'Goulasch-Menü', '', 2, 2, 2, 2, 1, 7.99);
INSERT INTO ORDERPOSITION (id, modificationCounter, offer_id, offername, comment, state, mealState, sidedishState, drinkState, order_id, price) VALUES (3, 1, 3, 'Pfifferlinge-Menü','', 2, 2, 2, 2,  1, 8.99);
INSERT INTO ORDERPOSITION (id, modificationCounter, offer_id, offername, comment, state, mealState, sidedishState, drinkState, order_id, price) VALUES (4, 1, 4, 'Salat-Menü', '', 2, 2, 2, 2, 1, 5.99);
INSERT INTO ORDERPOSITION (id, modificationCounter, offer_id, offername, comment, state, mealState, sidedishState, drinkState, order_id, price) VALUES (5, 1, 5, 'Cola', '', 2, 2, 2, 2, 1, 5.99);
