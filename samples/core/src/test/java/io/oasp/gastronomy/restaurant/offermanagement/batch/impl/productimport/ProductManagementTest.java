...
import static io.oasp.gastronomy.restaurant.offermanagement.common.constants.OffermanagementTestDataConstants.ID_PRODUCT_MEAL_SCHNITZEL;
import static io.oasp.gastronomy.restaurant.offermanagement.common.constants.OffermanagementTestDataConstants.NUMBER_OF_PRODUCT_DRINK;
import static io.oasp.gastronomy.restaurant.offermanagement.common.constants.OffermanagementTestDataConstants.NUMBER_OF_PRODUCT_MEAL;
import static io.oasp.gastronomy.restaurant.offermanagement.common.constants.OffermanagementTestDataConstants.NUMBER_OF_PRODUCT_SIDEDISH;
...
public class ProductManagementTest extends ComponentTest {
  ...
  public void testFindProductsFiltered() {
    ...
    assertEquals(products.size(), NUMBER_OF_PRODUCT_MEAL);
    ...
    assertEquals(products.size(), NUMBER_OF_PRODUCT_DRINK);
    ...
    products = this.offerManagement.findProductsFiltered(filter, sort);
    assertEquals(products.size(), NUMBER_OF_PRODUCT_SIDEDISH);
    ...
    filter.setFetchMeals(true);
    products = this.offerManagement.findProductsFiltered(filter, sort);
    assertEquals(products.size(), NUMBER_OF_PRODUCT_MEAL + NUMBER_OF_PRODUCT_SIDEDISH);

    filter.setFetchMeals(true);
    filter.setFetchDrinks(true);
    sort.setSortByEntry(ProductSortByHitEntry.ID);
    products = this.offerManagement.findProductsFiltered(filter, sort);
    assertEquals(products.size(), NUMBER_OF_PRODUCT_MEAL + NUMBER_OF_PRODUCT_SIDEDISH + NUMBER_OF_PRODUCT_DRINK);
