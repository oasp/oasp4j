...
import ${package}.general.common.api.RestService;
...
public class RestTestClientBuilder {
  ...
  /**
   * This method creates a proxy for the specified {@code RestService} interface. Use {@code ${symbol_pound}setLogin(String)} to set
