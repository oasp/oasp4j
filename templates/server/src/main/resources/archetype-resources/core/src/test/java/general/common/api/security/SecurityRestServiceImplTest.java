...
import ${package}.general.common.base.AbstractRestServiceTest;
import ${package}.general.service.impl.rest.SecurityRestServiceImpl;
...
public class SecurityRestServiceImplTest extends AbstractRestServiceTest {
  ...
  /**
   * This test depends on the login and csrf functionaility. These are tested in {@link ${symbol_pound}testLogin()} and
   * {@link ${symbol_pound}testGetCsrfToken()} respectively.
   */
  @Test
  @DirtiesContext
  ...
  /**
   * This test depends on the successful login which is tested by {@link ${symbol_pound}testLogin()}. Then, a csrf token is queried
   * and checked.
   */
  @Test
  @DirtiesContext
  public void testGetCsrfToken() {
    ...
    JSONObject expected =
        new JSONObject("{${symbol_escape}"headerName${symbol_escape}":${symbol_escape}"" + X_CSRF_TOKEN + "${symbol_escape}",${symbol_escape}"parameterName${symbol_escape}":${symbol_escape}"" + _CSRF + "${symbol_escape}"}");
