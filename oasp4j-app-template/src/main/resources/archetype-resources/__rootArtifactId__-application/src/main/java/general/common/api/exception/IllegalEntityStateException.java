...
/**
 * This exception is thrown if an {@link ${package}.general.common.api.ApplicationEntity entity} has a
 * specific state that is illegal for the current operation and caused it to fail.
 *
 * @author hohwille
 */
public class IllegalEntityStateException extends ApplicationBusinessException {
   ...
   * The constructor.
   *
   * @param cause the {@link ${symbol_pound}getCause() cause} of this error.
   * @param entity the entity that caused this error.
   * @param state the state of the entity that is illegal for the failed operation.
   */
