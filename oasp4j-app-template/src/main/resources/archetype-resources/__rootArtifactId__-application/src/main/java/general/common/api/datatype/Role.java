...
/**
 * Defines the available roles of a {@link ${package}.staffmanagement.common.api.StaffMember}.
 *
 * @see ${package}.staffmanagement.common.api.StaffMember${symbol_pound}getRole()
 *
 * @author hohwille
 * @author loverbec
 */
public enum Role implements Principal {
   ...
   * {@link ${package}.staffmanagement.common.api.StaffMember}s.
   */
  CHIEF("Chief"),
