 ...
 * search.<br/>
 * <b>NOTE:</b><br/>
 * This interface only holds generic settings for the query such as {@link ${symbol_pound}getHitOffset()},
 * {@link ${symbol_pound}getMaximumHitCount()}, and {@link ${symbol_pound}getSearchTimeout()}. For your individual search, you extend
...
public abstract class SearchCriteriaTo extends AbstractSearchCriteria implements TransferObject {
  ...
  /**
   * Limits the {@link ${symbol_pound}getMaximumHitCount() maximum hit count} by the given <code>limit</code>. If current
   * {@link ${symbol_pound}getMaximumHitCount() maximum hit count} is <code>null</code> or greater than the given <code>limit</code>,
   * the value is replaced by <code>limit</code>.
   *
   * @param limit is the maximum allowed value for {@link ${symbol_pound}getMaximumHitCount() maximum hit count}.
   */
