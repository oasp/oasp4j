 ...
 * interface interface <code>MyEntityDao</code> that inherits from this {@link IGenericDao} interface. Also you create an
 * implementation of that interface <code>MyEntityDaoImpl</code> that you derive from
 * {@link io.oasp.module.jpa.dataaccess.base.dao.AbstractGenericDaoImpl}.
 *
 ...
 *
 */
public interface IGenericDao<ID, E extends PersistenceEntity<ID>> extends FeatureForceIncrementModificationCounter<E> {
