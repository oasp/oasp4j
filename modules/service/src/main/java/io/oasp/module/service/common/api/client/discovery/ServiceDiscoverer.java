...
public interface ServiceDiscoverer {
   ...
   *        {@link ServiceDiscoveryContext#setConfig(io.oasp.module.basic.common.api.config.ConfigProperties)
   ...
   *        runtime exception causing the {@link io.oasp.module.service.common.api.client.ServiceClientFactory} to fail.
   */
