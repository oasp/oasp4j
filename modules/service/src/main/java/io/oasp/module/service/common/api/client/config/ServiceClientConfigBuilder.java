package io.oasp.module.service.common.api.client.config;
...
/**
 * A builder used to create the configuration for {@link io.oasp.module.service.common.api.Service} clients.
 *
 * @see io.oasp.module.service.common.api.client.ServiceClientFactory#create(Class, Map)
 */
public class ServiceClientConfigBuilder {
  ...
  /**
   * @param url the entire URL of the {@link io.oasp.module.service.common.api.Service}.
   * @return this instance for fluent API calls.
   */
