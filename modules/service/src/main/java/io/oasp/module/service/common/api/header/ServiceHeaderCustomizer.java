 ...
 * {@link io.oasp.module.service.common.api.client.ServiceClientFactory#create(Class) service client} is invoked these headers
 ...
 * token for authentication, passing {@link io.oasp.module.logging.common.api.LoggingConstants#CORRELATION_ID
 * correlation ID}, etc.).
 *
 * @since 3.0.0
 */
