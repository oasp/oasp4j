package io.oasp.module.service.common.api.client;
 ...
 * <ul>
 * <li>{@link io.oasp.module.service.common.api.client.discovery.ServiceDiscoverer#discover(io.oasp.module.service.common.api.client.discovery.ServiceDiscoveryContext)
...
public interface ServiceClientFactory {
   ...
   *        {@link io.oasp.module.service.common.base.config.ServiceConfigProperties} for further details.
   * @return a new instance of the given {@code serviceInterface} that is a client stub. Invocations to any of the
   *         service methods will trigger a remote call and synchronously return the result.
   */
